    ...
    add_layers(
      ...
      annotate("richtext",
        ...
        label = paste0(
          ...
          "The size of the board shows the uncertainty<br>",
          "in the number of electoral votes predicted for<br>",
          "Biden <strong>at the beginning of election night</strong><br>",
          "(per the Economist). The ball dropped<br>",
          "through the board shows <strong style='color: ", Biden_color, "'>the current result:</strong><br><br>",
