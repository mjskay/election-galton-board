...
```{r}
biden_states = c("CA", "NY")
trump_states = c("ND", "WV")
...
format_state_list = function(states) {
  paste(stringi::stri_wrap(paste(states, collapse = " "), width = 30, indent = 5), collapse = "<br>")
}
  ...
  plinko_board(..., 
    ...
    add_layers(
      ...
      annotate("richtext",
        x = 650, y = 0,
        label = paste0(
          "<strong style='color: black;'>Presidential-Plinko.com Live Board</strong><br><br>",
          ...
          "<strong style='color:", Trump_color, "';>Trump wins.</strong> The proportion of balls above<br>",
          "269 shows Biden's chance of winning."
        ),
        color = "gray25",
...
options(mc.cores = 6)
board_econ %>%
  animate(width = width_px, height = height_px, fps = 15, end_pause = 3 * 15)
```
