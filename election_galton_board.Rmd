...
```{r}
df_538 = read.csv("538_presidential_ev_probabilities_2020.csv")
```
...
The Normal approximation looks decent. Let's continue down this train a bit a use the binomial approximation to the Normal by finding a binomial distribution with the same variance and then shifting its location to match the above Normal distribution. 
