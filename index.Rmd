...
The above animation shows a single ball representing Biden's current total electoral votes 
dropped through a Plinko board whose height
roughly matches the uncertainty in [the Economist's](https://projects.economist.com/us-2020-forecast/president) 
election prediction model before any votes were counted.
How surprised would you feel to
see this outcome if you dropped a ball into a real
Plinko board of the same size?
